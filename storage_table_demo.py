...
resourcegroup_name = 'jlc'+''.join(random.choice(string.ascii_lowercase + 
string.digits) for _ in range(6))
storageaccount_name = 'jlc'+''.join(random.choice(string.ascii_lowercase + 
string.digits) for _ in range(6))
location = 'eastus'
###
...
coffee.flavor = 'white mocha'
coffee.cupsize 'medium'      
coffee.price = 6.95
table_service.insert_entity('itemstable', coffee)
print('Created entry for Seattle...\n')
time.sleep(1)
###
...
'cartypes'", select='make,model,price')
for item in items:
print('Make: ' + item.make)
print('Model: ' + item.model)
print('Price: ' + str(item.price) + '\n')
items = table_service.query_entities('itemstable', filter="PartitionKey eq 
'coffeeshop'", select='flavor,brand,price')
for item in items:
print('Flavor: ' + item.flavor)
print('Brand: ' + item.flavor)
print('Price: ' + str(item.price) + '\n')
time.sleep(1)
###
